...
export function vertexKernelDisplacementGraph(): GraphDocument {
	return {
		...
		nodes: [
			...
			snapshotNode('n_abs_noise', 'math.abs', { x: 460, y: 460 }),
		...
		edges: [
			...
			edge('e_noise_abs', 'n_noise', 'noise.perlin3d', 'n_abs_noise', 'math.abs', 0, 0),
			edge('e_z_displaced_a', 'n_z', 'vector.vec3f.z', 'n_displaced_z', 'math.add', 0, 0),
			edge('e_noise_displaced_b', 'n_abs_noise', 'math.abs', 'n_displaced_z', 'math.add', 0, 1),
